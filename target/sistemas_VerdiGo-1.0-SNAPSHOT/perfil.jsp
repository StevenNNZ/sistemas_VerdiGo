                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                    <div class="widget-content widget-content-area br-8">
                        <div class="middle-content container-xxl p-0">
                            ...
                            %>
                            <!-- CONTENT AREA -->
                            <form class="section general-info p-3" action="svPerfil" method="POST">
                                <div class="info">
                                    <h6 class="fs-3 mb-3">Información del Perfil del Usuario</h6>
                                    <div class="form">
                                        <div class="row">
                                            <!-- Nombres -->
                                            <div class="col-md-6">
                                            ...
                                            <!--<div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select mb-3" id="rol" name="rol" required disabled>
